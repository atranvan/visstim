function  stimulusInfo = HoldDriftHoldGray(q)
%HOLDMOVEHOLDGrayscreen  This function displays static then drifting then static
% gratings, all in the same direction, for specified times. Gray screen is

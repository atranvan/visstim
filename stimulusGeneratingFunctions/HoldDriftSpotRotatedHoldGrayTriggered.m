function  stimulusInfo = HoldDriftSpotRotatedHoldGrayTriggered(q)
%HOLDDriftReverseDriftHOLDGrayTRIGGERED  This function displays static then drifting then static
% gratings, all in the same direction, for specified times. A spot with a
% rotated grating is displayed in the middle of the drifting
